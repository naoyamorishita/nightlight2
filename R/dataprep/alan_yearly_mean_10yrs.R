...
convertH5ToAverageAlan(
  "F:/GIS Projects/nightlight/toBePublished/miami/miami_nightlihgt_yearly",
  "F:/GIS Projects/nightlight/toBePublished/BlackMarbleTiles/BlackMarbleTiles/BlackMarbleTiles.shp",
  "h09v06"
)
